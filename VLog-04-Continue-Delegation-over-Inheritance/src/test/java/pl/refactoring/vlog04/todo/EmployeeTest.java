...
public class EmployeeTest {
    ...
    public void baseSalaryFor1Hour(){
        Person person = PersonFactory.createPerson(1, "Adam", "Employee", CooperationType.EMPLOYEE, NightTimeRegulation.NIGHT_SHIFT_22_6, 8);
    ...
    public void nighttimeSupplementFor2Hours(){
        Person person = PersonFactory.createPerson(1, "Adam", "Employee", CooperationType.EMPLOYEE, NightTimeRegulation.NIGHT_SHIFT_21_5, 8);
