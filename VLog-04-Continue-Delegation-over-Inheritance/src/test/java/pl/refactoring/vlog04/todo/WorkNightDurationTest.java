...
public class WorkNightDurationTest {
    ...
    public void ending_nighttime(CooperationType type){
        Person person = PersonFactory.createPerson(1, "Adam", "Smith", type, NightTimeRegulation.NIGHT_SHIFT_21_5, 8);
    ...
    public void embracing_nighttime(CooperationType type){
        Person person = PersonFactory.createPerson(1, "Adam", "Smith", type, NightTimeRegulation.NIGHT_SHIFT_22_6, 8);
